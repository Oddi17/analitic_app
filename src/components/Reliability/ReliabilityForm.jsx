...
function ReliabilityForm({onSubmit}) {
   
    const [reabForm] = Form.useForm();
    const [dates, setDates] = useState([]);

    const handleSearch = () => {
      reabForm.validateFields().then((objform)=>{
    ...
    const handleDateChange = (values) => {
      ...
      setDates(values);
      reabForm.setFieldsValue({ range_date_time: values }); // Устанавливаем значение в форму
    };
...
export default ReliabilityForm