...
function AnaliticJournalForm({onSubmit}) {
   
    const [AJForm] = Form.useForm();
    const [dates, setDates] = useState([]);

    const handleSearch = () => {
      AJForm.validateFields().then((objform)=>{
    ...
    const handleDateChange = (values) => {
      ...
      setDates(values);
      AJForm.setFieldsValue({ range_date_time: values });
    };
...
export default AnaliticJournalForm